...
`$ wget -c https://github.com/rebuy-de/aws-nuke/releases/download/v2.25.4-instruqt/aws-nuke-v2.25.4-instruqt-linux-amd64.tar.gz -O - | tar -xz -C $HOME/bin`

Run
`$ aws-nuke-v2.25.4-instruqt-linux-amd64`
...
$ docker run \
    ...
    quay.io/rebuy/aws-nuke:v2.25.4-instruqt \
    --profile default \
